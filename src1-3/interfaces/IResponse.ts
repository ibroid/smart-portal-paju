...
export interface ICekSidangResponse {
    sidang: ISidangResponse;
    nomor_antrian: null | IDetailAntrianSidang;
}

export interface IKontenResponse {
    id: number;
    judul: string;
...
export interface IDriveThruCekResponse {
    id: number;
    user_id: number;
    nomor_perkara: string;
    pihak_pengambil: string;
    nomor_akta_cerai: string;
    tanggal_ambil: string;
    waktu_ambil: string;
    waktu_input: string;
    status_berkas: number;
    status_pengambilan: number;
    nomor_wa: string;
    created_at: string;
    updated_at: string;
}
